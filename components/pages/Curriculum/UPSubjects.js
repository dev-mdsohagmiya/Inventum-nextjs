...
export default function UPSubjects(props) {
  ...
  const customSubjectsNames = props.topSubjects ?? UPsubjectsjson;

  // Filter subjects based on their names
  const filteredSubjects = UPsubjectsjson.filter((subject) =>
              ...
              return (
                <div key={subject.name}>
                  <SubjectCards
                    ...
                    img={subject.img}
                    text={subject.text}
                    category={props.notitle ? "/learn/UP" : "UP"}
