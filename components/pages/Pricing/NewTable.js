    ...
    return (
        <section id="detailed-pricing" className="w-full bg-dl">
                ...
                <div class="bg-dl">
                    ...
                    <div class="grid grid-cols-2 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Study Coach check-ins twice a month (annually)</div>
                        <div className="flex justify-center items-center font-bold text-ll text-xl">
                            <p>300</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Study Coach check-ins once a week (annually)</div>
                        <div className="flex justify-center items-center font-bold text-ll text-xl">
                            <p>550</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Career Councelling (4 sessions)</div>   
                        <div className="flex justify-center items-center font-bold text-ll text-xl">
                            <p>250</p>
                        </div>
                    </div>
