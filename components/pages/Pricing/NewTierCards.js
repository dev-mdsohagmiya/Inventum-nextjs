...
export default function NewTierCards(props) {
  ...
  return (
    <div
      className={`px-4 mx-auto max-w-screen-xl lg:px-6 animatable ${
        inView ? "shown" : ""
      }`}
      ref={ref}
    >
      <div className="z-0 space-y-8  grid grid-cols-1 gap-5 sm:gap-6 xl:gap-10 lg:space-y-0 items-center lgxl:grid-cols-3 ">
        <div className="cont w-full h-[28rem] rounded-lg max-w-sm mx-auto">
          <div className="tier w-full rounded-lg bg-pg ">
              ...
              <ul className="mb-8 space-y-4 text-left">
                ...
                {props.igcse ? (
                  <li className="flex items-center space-x-3">
                    ...
                    <span>
                      One Mock Examination in subjects of choice (IGCSE 2){" "}
                    </span>
                  </li>
                ) : props.alevels ? (
                  <li className="flex items-center space-x-3">
            ...
            <a
              href={props.priceurl ?? "#calculate"}
              className="w-max mx-auto px-3 py-2 text-sm text-center bg-white font-bold rounded-full hover:brightness-[0.9] focus:ring-4 focus:outline-none"
            >
          ...
          <div className="image max-w-sm mx-auto rounded-lg w-full h-full bg-cover bg-[url(https://images.unsplash.com/photo-1471970471555-19d4b113e9ed?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80)]">
            <div className="justify-center mx-auto  text-center rounded-lg shadow text-ll w-full h-full max-w-sm">
              <div className="flex justify-center items-center flex-col h-full backdrop-brightness-[.45] py-8 px-5 rounded-lg gap-6">
                ...
                <div className="flex justify-center items-baseline my-3 pb-3">
                  <span className="mr-2 text-6xl font-extrabold">
                    €{props.tier1}
                  </span>
                  <span className="text-gray-300">/subject annually</span>
                </div>
                <p className="font-light  sm:text-lg text-ll mb-2">
        ...
        <div className="cont w-full h-[28rem] rounded-lg max-w-sm mx-auto">
            ...
            <div className="w-full">
              <ul className="mb-8 space-y-4 text-left">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>
                    Access to recorded precision teaching on critical parts of
          ...
          <div className="image rounded-lg w-full h-full">
            <div className=" h-full  items-center justify-center mx-auto max-w-sm text-center rounded-lg shadow text-ll bg-center bg-[url(https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1122&q=80)] bg-cover">
              <div className="flex justify-center items-center h-full flex-col backdrop-brightness-[.45] py-8 px-5 rounded-lg gap-6">
                ...
                <p className="font-light sm:text-lg text-ll pb-2">
                  Designed for independent learners who wish to benefit from the
                  structured guidance of recorded lessons and the possibility
                  for revision.
                </p>
              </div>
            </div>
            ...
            <div className="w-full">
              <ul className="mb-8 space-y-4 text-left">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>
                    Access to live lessons with precision teaching on critical
                    points of the curriculum for each subject
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="justify-center mx-auto text-center rounded-lg shadow text-ll w-full h-full max-w-sm">
              <div className="flex justify-center items-center h-full flex-col backdrop-brightness-[.45] py-8 px-5 rounded-lg gap-6">
                ...
                <p className="font-light sm:text-lg text-ll mb-2">
                  ...
                  real-time interaction and personalised support of critical
