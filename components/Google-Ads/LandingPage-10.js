...
const CallButton = dynamic(() => import("@/hooks/CallButton.js"));
...
const Mindset = dynamic(() => import("./components/Mindet.js"));
const FuTe = dynamic(() => import("./components/FuTe.js"));
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content={
          "The best online international private school in the world. We have 1 to 1 support from teachers and study coaches for all learners."
        }
      />
      <meta
        name="keywords"
        content={
          "online private school, online international private school, private international online school"
        }
      />
      <Suspense
        fallback={
      ...
      >
        <div className="bg-dl overflow-clip w-full">
...

            {
              <h1 className="text-3xl lg:text-5xl text-center text-white font-light">
                ...
                <span className="text-transparent bg-pg font-extrabold bg-clip-text">
                  {" "}
                  Online International Private School{" "}
                </span>
                where you can{" "}
          ...
          <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
            Experience premier education with our online private school and prep
            school programs. Our private online high schools offer personalised
            learning and top-tier academic support, ensuring students achieve
            their full potential in a flexible online environment.
          </p>
