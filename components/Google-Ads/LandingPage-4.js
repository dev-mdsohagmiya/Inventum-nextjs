      ...
      >
        <div className="bg-dl overflow-clip w-full">
...

            {
              <h1 className="text-3xl lg:text-5xl text-center text-white font-light">
                ...
                <span className="text-transparent bg-pg font-extrabold bg-clip-text">
                  {" "}
                  Online International GCSE School{" "}
                </span>
                where you can{" "}
          ...
          <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
            Our comprehensive online courses include GCE A Levels and GCSEs,
            with subjects like Physics, English, and Maths available for
            flexible online study. We offer specialised GCSE online tutoring and
            distance learning options, ensuring you can study at your own pace.
            Our GCSE English Language and Physics courses are designed to help
            you excel. With expert tutors and flexible schedules, our online
            GCSE courses provide the perfect solution for your educational
            needs.
          </p>
