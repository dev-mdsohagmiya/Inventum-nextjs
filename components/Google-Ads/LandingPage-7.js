      ...
      >
        <div className="bg-dl overflow-clip w-full">
...

            {
              <h1 className="text-3xl lg:text-5xl text-center text-white font-light">
                ...
                <span className="text-transparent bg-pg font-extrabold bg-clip-text">
                  {" "}
                  Online International Cambridge Middleschool{" "}
                </span>
                where you can{" "}
          ...
          <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
            Discover our accredited online middle school programs, offering
            top-rated education for 8th graders and junior high students. Our
            online classes for middle school are designed to provide a flexible
            and high-quality learning experience. Join one of the best online
            middle schools and benefit from personalised education tailored to
            your needs.
          </p>
          ...
          {openTab === 1 ? (
            <ISFSubjects
              customurl={`learn-7/middleschool`}
              notitle={true}
              topSubjects={[
                "History",
                "Digital-Literacy",
