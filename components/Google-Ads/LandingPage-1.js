...
const Mindset = dynamic(() => import("./components/Mindet"), { ssr: false });
const FuTe = dynamic(() => import("./components/FuTe"), { ssr: false });
  ...
  return (
    <>
      <div className="bg-dl overflow-clip w-full">
        ...
        <h2 className="text-7xl text-center flex self-center pt-10 font-bold bg-clip-text text-transparent bg-pg w-max mx-auto">
          Subjects
        </h2>
        <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
          Explore our accredited online high schools offering top-tier virtual
          high school programs. We provide the best online high school courses
          and classes tailored for both teens and adults. Whether you're looking
          to finish high school online or earn a high school diploma as an
          adult, our flexible online secondary education programs are designed
          to fit your needs. Join our private online high schools and benefit
          from quality online courses and personalised education. Get your high
          school diploma online with our comprehensive and accredited programs.
        </p>
        ...
        {openTab === 1 ? (
          <ISFSubjects
            customurl={`learn-8/middleschool`}
            notitle={true}
            topSubjects={[
              "History",
              "Digital-Literacy",
        ...
        <div id="calculate" className="">
          <OurPackagesNew subtitle="To accurately calculate the annual cost for your chosen courses, we encourage you to utilise the convenient calculator provided below. Kindly be aware that the calculation does not include the one-time registration fee of EUR 250." />
        </div>
