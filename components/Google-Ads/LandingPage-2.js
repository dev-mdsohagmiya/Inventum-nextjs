    ...
    <>
      <div className="bg-dl overflow-clip w-full">
        ...
        <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
          Join our international Cambridge program and access top-tier education
          online. We offer O Level online courses, BTEC programs, and private
          online schooling with dedicated teachers. As one of the best online
          schools, we provide flexible learning options for students worldwide.
          Experience the benefits of a virtual school, whether you're looking
          for a private online school or an international online high school.
          Our virtual high school offers comprehensive online learning tailored
          to your needs.
        </p>
