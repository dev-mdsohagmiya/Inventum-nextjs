...
const IGCSESubjects = lazy(() =>
  import("@/components/pages/Curriculum/IGCSESubjects.js")
);
const ISFSubjects = lazy(() =>
  import("@/components/pages/Curriculum/ISFSubjects.js")
);
const ASubjects = lazy(() =>
  import("@/components/pages/Curriculum/ASubjects.js")
);
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content={
          "The best online international alevels school in the world. We have 1 to 1 support from teachers and study coaches for all learners."
        }
      />
      <meta
        name="keywords"
        content={
          "online a-levels school, online a-levels international school, international online a-levels school"
        }
      />
      ...
      >
        <div className="bg-dl overflow-clip w-full">
...

            {
              <h1 className="text-3xl lg:text-5xl text-center text-white font-light">
                ...
                <span className="text-transparent bg-pg font-extrabold bg-clip-text">
                  {" "}
                  Online International A-Levels School{" "}
                </span>
                where you can{" "}
          ...
          <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
            Explore our A Level courses online, including Biology, Chemistry,
            English Language, and Math. We offer specialised classes such as
            Physics and Spanish, all designed for flexible online learning. Our
            distance learning A Levels are perfect for adults and international
            students, and are accepted by universities. Achieve your
            qualifications with fast-track and correspondence options, supported
            by expert tutors. Study at your own pace with the best online A
            Levels.
          </p>
