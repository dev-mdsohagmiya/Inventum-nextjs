    ...
    <>
      <div className="bg-dl overflow-clip w-full">
...

          {
            <h1 className="text-3xl lg:text-5xl text-center text-white font-light">
              ...
              <span className="text-transparent bg-pg font-extrabold bg-clip-text">
                {" "}
                Online International IGCSE School{" "}
              </span>
              where you can{" "}
        ...
        <p className="text-center mx-auto prose prose-invert max-w-[150ch] p-5">
          Discover our range of IGCSE online courses, perfect for flexible and
          effective learning. We offer specialised IGCSE online tutoring and
          homeschooling options, including Maths and Cambridge IGCSE courses.
          Our top online IGCSE schools provide comprehensive support and expert
          tutors to help you succeed. With the best online IGCSE schools, you
          can study at your own pace and excel in your subjects. Join our IGCSE
          online classes and experience the benefits of personalised education
          with dedicated IGCSE math tutors.
        </p>
