        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div class="flex space-x-4">
                ...
                <a className='h-max hover:scale-105' href='https://twitter.com/InventumOnline' target={'_blank'} rel='noreferrer'><FontAwesomeIcon icon={['fab', 'twitter']} size='xl' /></a>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="journeys-and-fees" className="text-gray-300 hover:text-white">
                    Journey & Fees
                  </a>
                </li>
                <li>
                  <a href="well-being" className="text-gray-300 hover:text-white">
                    Well-being
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="https://issuu.com/cobussteyn/docs/inventum_international_general_conditions_2023-24?fr=sMTI5NjQzMDU3Mjc" className="text-gray-300 hover:text-white">
          ...
          {/* Right Column - Awards */}
          <div>
            <h3 className="text-xl text-center font-medium mb-4">Accreditations</h3>
