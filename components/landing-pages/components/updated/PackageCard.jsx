          ...
          >
            ...
            <div className="mt-auto bg-[#162033] p-5 rounded-2xl transition-all duration-300 ease-in-out h-max">
              ...
              {pkg.loadMore && (
                <button
                  onClick={() =>
                    setLoadmore((prev) => ({ ...prev, [index]: true }))
                  }
                  className={`text-[#fff] underline text-sm font-medium mt-2 transition-all duration-300 ease-in-out ${
                    !loadmore[index] ? "block" : "hidden"
                  }`}
                >
                  Load more
                </button>
              ...
              >
                ...
                {pkg.loadMore && (
                  <button
                    onClick={() =>
                      setLoadmore((prev) => ({ ...prev, [index]: false }))
                    }
                    className={`text-[#fff] underline text-sm font-medium mt-2 transition-all duration-300 ease-in-out ${
                      loadmore[index] ? "block" : "hidden"
                    }`}
