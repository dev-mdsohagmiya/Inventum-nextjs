    ...
    <section className={`bg-dl h-max py-28`}>
      ...
      >
        ...
        {props.notext ? (
          ...
          <p className="mb-5 font-light sm:text-xl text-ll max-w-7xl mx-auto px-5">
            People are different. Nobody learns exactly the same. To meet
            individual needs, Inventum International offers three different
            learning journeys to provide for different learning styles. While
            all our learning journeys include a comprehensive base to enable the
            successful development of skills and knowledge, Journey 2 also
            includes recorded lessons. Journey 3 makes provision for live
            lessons. If you are unsure which journey to choose, try out our{" "}
            <a
