...
export default function TierCards(props) {
    ...
    return (
        ...
        <StyledModal id='1' closeAfterTransition
        slots={{ backdrop: Backdrop }} open={modal1IsOpen} onClose={()=> {setModal1IsOpen(false); }} className={` overflow-y-auto`}>
            <Fade in={modal1IsOpen}>
                ...
                <div class="bg-dl justify-center">
                    <div class="w-full text-center grid grid-cols-4 p-4 text-xs md:text-sm border-t border-b  md:gap-x-16 justify-between bg-gray-800 border-gray-700 text-ll font-bold sm:text-[1rem]">
                        <div class="flex items-center justify-center w-full">Packages</div>
                        <div className='w-full'>Journey 1: Autonomous Learning Experience</div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Lessons in Canvas</div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Online books</div>
                        <div className="flex justify-center items-center">
                           <img src={CheckSVG} alt=''/>
                        </div>
                        <div className="flex justify-center items-center">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Tutor Contact (10 per subject, per year)</div>
                        <div className="flex justify-center items-center">
                           <img src={CheckSVG} alt=''/>
                        </div>
                        <div className="flex justify-center items-center">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Quizzes</div>
                        <div className="flex justify-center items-center">
                           <img src={CheckSVG} alt=''/>
                        </div>
                        <div className="flex justify-center items-center">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">End of unit tests</div>
                        <div className="flex justify-center items-center">
                           <img src={CheckSVG} alt=''/>
                        </div>
                        <div className="flex justify-center items-center">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600 ">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Dedicated study coach check ins</div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Future technology modules</div>
                        <div className="flex justify-center items-center font-bold bg-clip-text bg-pg text-transparent text-2xl">
                            <p>2</p>
                        </div>
                        <div className="flex justify-center items-center font-bold bg-clip-text bg-pg text-transparent text-2xl">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Personal and Mindset Growth Modules</div>
                        <div className="flex justify-center items-center font-bold bg-clip-text bg-pg text-transparent text-2xl">
                            <p>4</p>
                        </div>
                        <div className="flex justify-center items-center font-bold bg-clip-text bg-pg text-transparent text-2xl">
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm text-ll border-b  md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Mock exams</div>
                        <div className="flex justify-center items-center">
                            <p></p>
                        </div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">Career readiness assignments</div>
                        <div className="flex justify-center items-center">
                            <p></p>
                        </div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full font-bold sm:text-[1rem] text-xs">CAT4 Test</div>
                        <div className="flex justify-center items-center">
                            <p></p>
                        </div>
                    ...
                    <div class="grid grid-cols-4 px-4 py-5 text-sm border-b md:gap-x-16 justify-between border-gray-600">
                        <div class="text-ll w-full  font-bold sm:text-[1rem] text-xs">Global Citizenship Development</div>
                        <div className="flex justify-center items-center">
                            <p></p>
                        </div>
