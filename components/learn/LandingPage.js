...
import TierCustomTabs from "./sections/NewTierCustomTabs";
...
import IGCSESubjects from "./sections/IGCSESubjects";

import ISFSubjects from "./sections/ISFSubjects";

import CallButton from "@/hooks/CallButton";
import ASubjects from "./sections/ASubjects";
import NewPriceCalc from "./sections/NewPriceCalc";
import PT from "./sections/pt/PT";

import FuTe from "@/components/google-ads/FuTe";
import Mindset from "@/components/google-ads/Mindet";
    ...
    <div className="bg-dl overflow-clip w-full">
      ...
      <div className="bg-dd px-1 pb-5">
        ...
        <h3 className="text-white text-center text-xl lg:text-2xl max-w-prose mx-auto">
          ...
          During the call, we will assist you in selecting the option that best
          aligns with your child's needs and provide clarity on any questions
          you may have.
        </h3>
        <div className="max-w-[90vw] mx-auto my-5">
          <CallInline />
