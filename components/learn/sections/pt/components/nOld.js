...
const NOld = () => {
  return (
    <div className='py-20'>
      <h2 className="text-5xl font-bold text-transparent bg-pg bg-clip-text pb-3 mx-auto max-w-6xl pt-8 text-center"><AnimatedTitle /> cause knowledge gaps</h2>
      ...
      <div className='prose px-7 pt-5 pb-3 text-ll m-5 prose-h3:bg-pg prose-h3:bg-clip-text prose-h3:text-transparent bg-dd lg:w-1/3 w-11/12 lg:mx-auto  rounded-2xl -mb-1 max-w-sm'>
        ...
        <div className='-mt-5'>
        <p>Start of the academic year with clear plans on how and when to teach all of the content.</p>
        </div>
      </div>
      <ScrollComponent firstTitle="2. Students Can't Conform 100%" firstDescription="<p>Students will miss certain lessons</p><ul><li> due to an appointment</li><li> get bored because it's too easy</li> <li>miss key information due to a lack of concentration</li><li> ...</li></p>" lastTitle="3. A Predefined Pace For All" lastDescription="<ul><li>Students work at the pace of the middle of the class</li><li>Teacher tries very hard to differentiate and meet all learning needs</li><li>Students become bored or left behind</li></ul>" />
      <ScrollComponent firstTitle="4. Content Seen > Understood" firstDescription="<ul><li> Strong focus on completing content</li><li>Less focus on individual student knowledge retention</li></ul>" lastTitle="5. Knowledge Gaps" lastDescription="<p>End of academic year Either content not completed or rushed Students have knowledge gaps.</p>" />
    </div>
  );
};
